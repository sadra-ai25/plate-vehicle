...
class CRNNModelTorch(nn.Module):
    ...
    def __init__(self, img_h, n_channels, n_classes, n_hidden, lstm_input=64):
        ...
        # Edited for after version (improved --> bach normalization)
        block_0 = BlocksTorch.conv_norm_act(n_channels, 64, pooling='max', norm="bn")
        block_1 = BlocksTorch.conv_norm_act(64, 128, pooling='max', norm="bn")
        block_2 = BlocksTorch.conv_norm_act(128, 256, norm="bn")
        block_3 = BlocksTorch.conv_norm_act(256, 256, pooling='max', pooling_s=(2, 1), pooling_k=(2, 1), norm="bn")
        block_4 = BlocksTorch.conv_norm_act(256, 512, norm="bn")
        block_5 = BlocksTorch.conv_norm_act(512, 512, pooling='max', norm="bn", pooling_s=(2, 1), pooling_k=(2, 1))
        block_6 = BlocksTorch.conv_norm_act(512, 512, k=2, p=0, norm="bn")
